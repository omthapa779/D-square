...
<head>
    ...
    <title>D-Square | System Announce</title>
...
<body id="top">
   ...
   <header id="header" class="row">   
    ...
    <section id="styles" >
       ...
       <h1>System Announce</h3>

<form method="POST" action="{{route('store.announce')}}">
      @csrf
   <div>
      <label for="title">Enter Announcement Title</label>
      <input class="full-width" type="text" placeholder="Job Vacantion for Romania" id="title" name="title" autofocus>
  </div> 
        <div>
      <label for="Description">Enter Description</label>
      <input class="full-width" type="text" placeholder="Description....." id="description" name="description">
  </div> 
        <div>
      <label for="Description">Posted By:</label>
      <input class="full-width" type="text" placeholder="Kushal Shrestha..." id="posted_by" name="posted_by">
  </div> 
        <input class="button-primary" type="submit" value="Announce">
      </form>
  </div>
  <br><br><br><br>
